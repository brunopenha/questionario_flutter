...
void main() {
  ...
  group('get', () {
    ...
    test('Deveria retornar UnauthorizedError se o GET retornar 401', () async {
      retornoMockado(401);
    ...
    test('Deveria retornar ForbiddenError se o GET retornar 403', () async {
      retornoMockado(403);
    ...
    test('Deveria retornar ServerError se o GET lançar uma exceção', () async {
      erroMockado();
